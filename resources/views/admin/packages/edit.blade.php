...
<head>
    ...
    <title>Edit Paket - Studio BUMA</title>
...
<body>
    <div class="container">
        <div class="form-header">
            <h1>✏️ Edit Paket</h1>
            <p>Perbarui data paket di bawah</p>
        </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="type" name="type" required>
                        ...
                        <option value="grup" {{ old('type', $package->type) === 'grup' ? 'selected' : '' }}>Grup</option>
                        <option value="family" {{ old('type', $package->type) === 'family' ? 'selected' : '' }}>Family</option>
                    </select>
                    @error('type')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
